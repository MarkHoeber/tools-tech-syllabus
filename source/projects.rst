...
The project is to produce a substantial document through one of the tools we
examine over the semester.

I recommend doing the project in one of the markup Languages we work with in
the first half of the course, for several reasons:

* You will have more time to apply what we learn. I expect that you will put
  substantial time into the project, and if you wait to use tools we cover
